			...
			<div className="mx-auto max-w-7xl px-4 py-4 sm:px-6 lg:px-8">
				<nav className="flex flex-wrap items-center justify-between gap-4" aria-label="Main navigation">
					...
					<Link to="/" className="group inline-flex items-center gap-3 flex-shrink-0">
						<span className="flex h-11 w-11 items-center justify-center rounded-2xl bg-gradient-to-br from-amber-300 to-orange-500 text-slate-950 shadow-lg shadow-amber-500/30 transition duration-200 group-hover:shadow-amber-500/50 group-hover:scale-105">
							...
							<NavLink
								...
								className={({ isActive }) =>
									`rounded-full border px-4 py-2 text-sm font-semibold transition duration-200 ${
										isActive
											? 'border-white/10 bg-white/10 text-white shadow-lg shadow-amber-500/10'
					...
					<button
						type="button"
						className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-white/10 bg-white/5 text-white transition hover:border-amber-300 lg:hidden"
				...
				{isMenuOpen && (
						<div className="mt-4 space-y-3 rounded-2xl border border-white/10 bg-white/5 p-4 shadow-lg shadow-slate-950/30 lg:hidden">
						...
						<div className="space-y-2">
							<button
								type="button"
									className="flex w-full items-center gap-3 rounded-xl px-4 py-3 text-sm font-semibold text-slate-200 transition hover:bg-white/10"
							>
